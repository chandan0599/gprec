...
psql -U lakkavaramsaichandan -d lakkavaramsaichandan -f database/postgres/schema.sql
psql -U lakkavaramsaichandan -d lakkavaramsaichandan -f database/postgres/seed.sql
```
...
```bash
python3 tools/portal_db_server.py
```
